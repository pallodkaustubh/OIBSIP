...
public class User {
        ...
        public boolean withdraw(double amount) {
            if (amount > accountBalance) {
                ...
                String transaction = "Withdrawal: -$" + amount + " New balance: $" + accountBalance;
        ...
        public void deposit(double amount) {
            accountBalance += amount;
            String transaction = "Deposit: +$" + amount + " New balance: $" + accountBalance;
            transactionHistory.add(transaction);
        }
        ...
        public boolean transfer(double amount, User recipient) {
            if (amount <= accountBalance) {
                ...
                transactionHistory.add("Transfer of $" + amount + " to User " + recipient.getUserID());
                return true;
            } else {
                return false;
            }
